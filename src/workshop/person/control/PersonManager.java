...
import worspace.person.entity.PersonEntity;

public class PersonManager {
	public static void main(String[] args) {
		/*
		 * persons는 PersonEntity[] type
		 * persons[0]은 PersonEntity() type
		 */
	...
	public int findByGender(PersonEntity[] persons, char gender) {
		int genderCnt = 0;
		for (PersonEntity person : persons) {
			//char type은 primitive type이므로 비교할 때 == 연산자를 사용해도 됨.
